    ...
    async def sign_event(
        ...
        *,
        ...
        async with self._signing_lock:
            ...
            date_obj = datetime.datetime.strptime(timestamp, SIGV4_TIMESTAMP_FORMAT)
            # preserve UTC timezone lost with strptime, denoted in the string by Z
            date_obj.replace(tzinfo=datetime.UTC)
