...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            'Field(name=fname, value=["fval1", "fval2"], kind=FieldPosition.HEADER)',
        ),
        (
            Field(name="fname", kind=FieldPosition.TRAILER),
            "Field(name=fname, value=None, kind=FieldPosition.TRAILER)",
        ),
        (
            Field(name="fname"),
            "Field(name=fname, value=None, kind=FieldPosition.HEADER)",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            Fields([Field(name="fname1")]),
            "Fields([Field(name=fname1, value=None, kind=FieldPosition.HEADER)])",
        ),
    ],
)
